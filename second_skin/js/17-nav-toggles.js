/* ==========================================================================
   ...
   (window.SECOND_SKIN.rightOpen, set by the user here) are tracked
   separately and combined into "rb-right-visible".
   ========================================================================== */

window.SECOND_SKIN = window.SECOND_SKIN || {};
window.SECOND_SKIN.rightOpen = true;
...
window.rbNavBuildDOM = function () {
	...
	backdrop.addEventListener("click", function () {
		...
		if (window.SECOND_SKIN.rightOpen) { window.rbToggleRight(); }
	});
	...
	if (window.rbIsMobile()) {
		...
		window.SECOND_SKIN.rightOpen = false;
	}
...
window.rbToggleRight = function () {
	window.SECOND_SKIN.rightOpen = !window.SECOND_SKIN.rightOpen;
	window.rbNavSync();
};
...
window.rbNavSync = function () {
	...
	var rightVisible = rightEligible && window.SECOND_SKIN.rightOpen;
