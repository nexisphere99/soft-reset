/* ==========================================================================
   SECOND_SKIN   06 WARDROBE ENGINE
...
window.SECOND_SKIN.wardrobeSlots = ["top", "bottom", "bra", "underwear", "shoes", "accessory", "outerwear"];

/**
 * window.rbEquip(item)
 * item: { id, name, type, img, fem, att, cor, owned, equipped }
 * `type` must match one of SECOND_SKIN.wardrobeSlots.
 */
