...
window.SECOND_SKIN.noSidebarPassages = ["Start", "AgeGate", "CharCreate", "CharCreate2"];
...
window.rbRenderOutfit = function (sv) {
	var slots = window.SECOND_SKIN.wardrobeSlots || ["top", "bottom", "bra", "underwear", "shoes", "accessory", "outerwear"];
...
window.rbRenderRelationships = function (sv) {
	var mains = window.SECOND_SKIN.mainPartners || ["nolan", "jordan", "sophie", "river", "vanessa"];
	var names = { nolan: "Nolan", jordan: "Jordan", sophie: "Sophie", river: "River", vanessa: "Vanessa" };
	var colors = { nolan: "var(--blue)", jordan: "var(--red)", sophie: "var(--rose)", river: "var(--green)", vanessa: "var(--accent)" };
...
window.rbSidebarRender = function () {
	...
	var hidden = window.SECOND_SKIN.noSidebarPassages.indexOf(State.passage) !== -1;
