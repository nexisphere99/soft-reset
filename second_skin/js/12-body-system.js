/* ==========================================================================
   SECOND_SKIN   12 BODY / TRANSFORMATION SYSTEM
...
window.SECOND_SKIN.cupOrder = ["A", "B", "C", "D", "DD", "DDD"];
...
window.checkPhase2Progress = function () {
	...
	if (newCup && newCup !== body.braCup) {
		var oldIdx = window.SECOND_SKIN.cupOrder.indexOf(body.braCup);
		var newIdx = window.SECOND_SKIN.cupOrder.indexOf(newCup);
		if (newIdx > oldIdx) {
			body.braCup = newCup;
