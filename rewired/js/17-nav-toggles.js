/* ==========================================================================
   ...
   (window.REWIRED.rightOpen, set by the user here) are tracked
   separately and combined into "rb-right-visible".
   ========================================================================== */

window.REWIRED = window.REWIRED || {};
window.REWIRED.rightOpen = true;
...
window.rbNavBuildDOM = function () {
	...
	backdrop.addEventListener("click", function () {
		...
		if (window.REWIRED.rightOpen) { window.rbToggleRight(); }
	});
	...
	if (window.rbIsMobile()) {
		...
		window.REWIRED.rightOpen = false;
	}
...
window.rbToggleRight = function () {
	window.REWIRED.rightOpen = !window.REWIRED.rightOpen;
	window.rbNavSync();
};
...
window.rbNavSync = function () {
	...
	var rightVisible = rightEligible && window.REWIRED.rightOpen;
