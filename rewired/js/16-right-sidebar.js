...
window.REWIRED.noSidebarPassages = ["Start", "AgeGate", "CharCreate", "CharCreate2"];
...
window.rbRenderOutfit = function (sv) {
	var slots = window.REWIRED.wardrobeSlots || ["top", "bottom", "bra", "underwear", "shoes", "accessory", "outerwear"];
...
window.rbRenderRelationships = function (sv) {
	var mains = window.REWIRED.mainPartners || ["nolan", "jordan", "sophie", "river", "vanessa"];
...
window.rbSidebarRender = function () {
	...
	var hidden = window.REWIRED.noSidebarPassages.indexOf(State.passage) !== -1;
