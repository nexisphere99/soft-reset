/* ==========================================================================
   REWIRED   12 BODY / TRANSFORMATION SYSTEM
...
window.REWIRED.cupOrder = ["A", "B", "C", "D", "DD", "DDD"];
...
window.checkPhase2Progress = function () {
	...
	if (newCup && newCup !== body.braCup) {
		var oldIdx = window.REWIRED.cupOrder.indexOf(body.braCup);
		var newIdx = window.REWIRED.cupOrder.indexOf(newCup);
		if (newIdx > oldIdx) {
			body.braCup = newCup;
