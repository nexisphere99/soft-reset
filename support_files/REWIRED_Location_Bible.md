# REWIRED   Complete Location Bible
...
*This document is the definitive location bible for REWIRED. Every district, location, sub-venue, and action is mapped with unlock conditions, NPC assignments, price ranges, and thematic descriptions. Hand this to the code agent alongside the Day Content files and Hub Architecture prompt.*
