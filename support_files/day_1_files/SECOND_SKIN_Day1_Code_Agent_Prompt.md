# PROMPT FOR CODE AGENT   Add Day 1 to SECOND SKIN

---

## CONTEXT

You have already built the Day 0 version of SECOND SKIN (a SugarCube 2.37+ Twine game). The game has:
...
1. **`SECOND_SKIN_Day1_Content_FirstPerson.md`**   Complete Day 1 prose (first person, ~8,200 words), passage mapping, SugarCube logic blocks, choices, image prompts, and 100% beat verification
...
| `D01_EveningHome` | `passages/day01/d01-eveninghome.twee` | Ramen, Nolan's call, bed, 3:30 AM wet fingers |
...
```
This means if the player chose "Mia" during CharCreate, the ID reads "Mia Cole." If they chose "Luna" or any other name, it reflects that.
...
```bash
tweego -o build/second-skin-compiled.html \
  second-skin.twee \
