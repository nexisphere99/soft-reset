# PROMPT FOR CODE AGENT   Add Day 1 to REWIRED

---

## CONTEXT

You have already built the Day 0 version of REWIRED (a SugarCube 2.37+ Twine game). The game has:
...
1. **`REWIRED_Day1_Content_FirstPerson.md`**   Complete Day 1 prose (first person, ~8,200 words), passage mapping, SugarCube logic blocks, choices, image prompts, and 100% beat verification
...
```bash
tweego -o build/rewired-compiled.html \
  rewired.twee \
