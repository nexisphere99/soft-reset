# SECOND SKIN — Day 2 Supplementary Content
...
This content supplements `SECOND_SKIN_Day2_Content_FirstPerson.md`. The main file contains the **core story scenes** (wake up, thrift store/Marlene, catcall, trying on clothes, evening). This file contains **everything else that can happen on Day 2** — the ambient world, the random encounters, the shop conversations, the phone notifications that make the day feel alive and open.
...
> 
> I stare at the notification. I've been "sick" for two days. Owen hasn't questioned it but he will soon. I need to go back. I need the money. I need to ride my scooter through the city in this body and hand food to strangers who will see a woman and not think twice about it.
> 
...
### Phone: Afternoon Text — Nolan (1:30 PM)
...
> 💬 **Nolan:** hey
> 💬 **Nolan:** so I know you said you're sick
> 💬 **Nolan:** but you've been MIA for like 3 days and I'm starting to worry
> 💬 **Nolan:** like actual worry not bro worry
> 💬 **Nolan:** are you dying??
...
> 💬 **Nolan:** bro you were always ugly that's not new
> 💬 **Nolan:** 😂😂
> 💬 **Nolan:** seriously tho. you good?
> 💬 **Me:** yeah. just need a few more days
> 💬 **Nolan:** ok but I'm coming over soon whether you like it or not
> 💬 **Nolan:** bringing soup
> 💬 **Me:** jake
> 💬 **Nolan:** SOUP
...
> 💬 **Nolan:** ...
> 💬 **Nolan:** that sounds serious
> 💬 **Nolan:** should I come now?
> 💬 **Me:** not yet. give me till monday?
> 💬 **Nolan:** monday. ok. but if I don't hear from you monday I'm breaking down your door
> 💬 **Nolan:** I know where you hide the spare key
> 💬 **Me:** ...how do you know that
> 💬 **Nolan:** bro I've known you for 2 years. under the fire extinguisher on 3rd floor. it's not exactly CIA level
> *(Sets $jakeVisitDay = 5)*
...
> 💬 **Nolan:** ok
> 💬 **Nolan:** ...
> 💬 **Nolan:** you know I'm here right
> 💬 **Me:** I know
> *(Nolan doesn't text again for 2 days — he respects boundaries but it costs him. Nolan affinity -2 for the distance.)*
...
```
I'm scrolling through my contacts. Most of them are delivery-related — restaurant numbers, Owen, the DashDrop helpline. A few campus people. Nolan.
...
I hover my thumb over it. What would I say? "Hey Mom, it's Marcus. Except I'm not Marcus anymore. I'm a woman now. A pharmaceutical company did it. How's Florida?"
...
### Scene: Buying Groceries from Hector

```
The bell dings when I push open the door. Lucky Mart. The fluorescent lights hum their eternal hum. Hector is behind the counter, newspaper open, reading glasses perched on his nose, a half-eaten empanada next to the register.

"Morning, miss." He says it without looking up. "Need a bag?"

Miss. From Hector. Who called me "kid" and "buddy" for eight months when I was Marcus. Who knows — knew — my cereal preferences and my inability to afford real food. Now I'm "miss." A stranger in the store where I was a regular.

"Yeah. Thanks."

I grab a basket. Navigate the aisles. My shopping list has changed along with my body:

Milk (not expired this time). Eggs. Bread. Bananas — I've been craving fruit since the transformation, which is weird because Marcus's relationship with produce was strictly theoretical. Instant ramen (old habits). Pasta and sauce (I'm going to learn to cook if it kills me). A candy bar because I deserve it.
...
"Nice reflexes." She grins. "I'm Ananya. Not the lingerie Ananya — I don't know any lingerie Ananya, that would be weird. Just... Ananya."
...
**Logic:**
```
<<set $metAnanyaStore = true>>
<<set $phone.contacts.push({name:"Ananya (Corner Store)", number:"555-0188", met:"Day 2", notes:"Pre-law. Hot Pockets. Purple ink."})>>
```

### Hector — Checkout Conversation

**TYPE:** Guaranteed — plays during purchase

```
Hector rings me up. The register clunks with each item. He pauses on the women's shampoo.

"Switching brands?" He asks it casually. Like it's about shampoo. Maybe it is about shampoo.

"Yeah. Trying something new."

He looks at me over his reading glasses. Really looks. For a moment I'm terrified — does he see something? Does he see Marcus behind my face?
...
I want to laugh. I want to say: Hector, I've walked these blocks a thousand times. I know the crack in the sidewalk outside your store. I know which streetlight flickers. I know you close early on Sundays because your wife makes arroz con pollo and you'd rather be there than here.

Instead I say: "I will. Thanks, Hector."
...
I laugh. It surprises me — the sound. Higher than it used to be. A real laugh, not the quiet huff Marcus used to manage. This one has air in it. This one has shape.
...
"Nice to meet you, Mia. Your machine's done."
...
### Scene: Finding Marcus's Stuff (My Room, During Wardrobe Access)

**TRIGGER:** First time MC opens closet after buying women's clothes

```
I open the closet to hang the new clothes and Marcus is still there.
...
The closet is split now. Left side: Marcus's clothes, hanging limp, waiting for a body that isn't coming back. Right side: two t-shirts, one pair of jeans, and a sports bra, still slightly damp from the sink wash.

It's a small closet. There isn't room for two people's wardrobes. Not for long.

I push Marcus's clothes to the far left. Make room. The hangers scrape against the rod with a sound like teeth.
...
I've never been in a hair salon. As Marcus, I went to a barber — $15, ten minutes, sports on the TV, done. Women's salons are different. They're temples. I can see the products lining the walls, the wash stations, the mirrors surrounded by lights. A whole industry built around hair. My hair — this dark brown cascade that's past my shoulders and growing — is going to need that industry eventually.
...
Photos of Marcus. Not many — he wasn't the selfie type. But they're there. A group photo from freshman orientation — Marcus in the back row, shortest by default, hoodie pulled up despite being indoors. A photo Nolan took at the gym — Marcus attempting a deadlift, face like he's passing a kidney stone, arms like pipe cleaners. A screenshot of a text conversation with his dad: three messages, two from Marcus ("Happy birthday dad" and, three months later, "Merry Christmas"), one from Dad ("Thanks bud"). That's the whole relationship. Three texts and the word "bud."

I swipe to the most recent photo taken by the phone's camera. It's from the NovaCure exam room — the new ID photo Nurse Patel took. A woman with Marcus's eyes and nobody else's face, looking at the camera like she's been caught doing something she can't explain.

I look at the two photos side by side. Marcus at orientation. Mia at NovaCure.
...
| Nolan afternoon text (3 response options) | `Apt_Phone` → conditional on time | `$timeslot == "Afternoon"` and player opens phone |
...
| Corner Store scene (Hector, groceries, Ananya NPC) | `Loc_CornerStore` | MC visits Corner Store on Day 2 |
| Walking Trail scenes (Old Man, Mom with Stroller, Joggers) | `Loc_WalkingTrail` | MC visits Walking Trail on Day 2 |
| Laundromat scene (Estelle) | `Loc_Laundromat` | MC visits Laundromat on Day 2 |
...
| Finding Marcus's stuff in closet | `Apt_Wardrobe` | First time opening closet with new clothes |
...
|---|---|---|---|
| Corner Store | Ananya (aisle collision) | 40% | 1 |
| Corner Store | Hector extended chat | 100% | 1 (at checkout) |
| Walking Trail | Old Man on Bench | 100% (first visit) | 1 |
| Walking Trail | Mom with Stroller | 30% | 1 |
| Walking Trail | Arguing Joggers | 25% | 1 |
| Laundromat | Estelle (towel folder) | 35% | 1 |
