# REWIRED — Day 2 Supplementary Content
...
This content supplements `REWIRED_Day2_Content_FirstPerson.md`. The main file contains the **core story scenes** (wake up, thrift store/Marlene, catcall, trying on clothes, evening). This file contains **everything else that can happen on Day 2** — the ambient world, the random encounters, the shop conversations, the phone notifications that make the day feel alive and open.
