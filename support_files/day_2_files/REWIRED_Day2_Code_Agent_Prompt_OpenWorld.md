# PROMPT FOR CODE AGENT — Add Day 2 to REWIRED (Open World Architecture)
...
You have built Days 0–1 of REWIRED. Day 0 was linear (tutorial day — acceptable). Day 1 was mostly linear (crisis day — acceptable). Starting Day 2, the game transitions into its open-world structure.
